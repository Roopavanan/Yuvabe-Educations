...
export default function WhatYouLearn() {
  return (
    <section className="bg-white py-16 md:py-20">
      <div className="max-w-[1240px] mx-auto px-5 md:px-8 xl:px-0 flex flex-col items-center">
        {/* Header */}
        <motion.div
        ...
        {/* Image */}
        <motion.div
          className="relative w-full max-w-200 rounded-3xl overflow-hidden aspect-800/450 border border-[#D9A404]/20 shadow-[0_16px_40px_rgba(0,0,0,0.08)] mb-12"
          ...
          {pillars.map(({ icon: Icon, title, description }, index) => (
            ...
            >
              <div className="w-11 h-11 rounded-xl bg-[#FDF1D2] flex items-center justify-center">
                <Icon className="w-5 h-5 text-[#B8790A]" strokeWidth={2} />
              </div>
